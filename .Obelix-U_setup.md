...
### Usual suspects
```sh
sudo apt install python-pip python-gpg git vim i3 mpv conky ubuntu-restricted-extras flatpakm mplayer feh tilda qutebrowser libpulse-dev py3status libboost-program-options-dev
```
